tortoisecoin Core version 0.14.2 is now available from:
  ...
  <https://download.tortoisecoin.org/tortoisecoin-0.14.2.0/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://groups.google.com/forum/#!forum/tortoisecoin-dev>
...
tortoisecoin Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in tortoisecoin Core 0.10.4) it has been disabled by default.
...
- http://testnet.tortoisecointools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/tortoisecoin-project/tortoisecoin/blob/master/src/chainparams.cpp#L220).
...
tortoisecoin Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/tortoisecoin-project/tortoisecoin/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in tortoisecoin Core 0.10.4 and removed in 0.13.2. 
...
here, originally written for Bitcoin but can also be used for tortoisecoin:
