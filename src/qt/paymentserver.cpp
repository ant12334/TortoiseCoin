...
const QString BITCOIN_IPC_PREFIX("tortoisecoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/tortoisecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/tortoisecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/tortoisecoin-paymentrequest";
