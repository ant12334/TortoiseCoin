...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s tortoisecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  tortoisecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tortoisecoin transaction") + "\n" +
              "  tortoisecoin-tx [options] -create [commands]   " + _("Create hex-encoded tortoisecoin transaction") + "\n" +
              "\n";
