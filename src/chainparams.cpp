...
{
    const char* pszTimestamp = "NY Times 05/Oct/2024 Steve Jobs, Apple’s Visionary, Dies at 56";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 10000000000;
        ...
        genesis = CreateGenesisBlock(1732235901, 109999, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x4966625a4b2851d9fdee139e56211a0d88575f59ed816ff5e6a63deb4e3e29a0"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.tortoisecoin.loshan.co.uk", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("tortoisecointools.com", "dnsseed.tortoisecointools.com"));
        //vSeeds.push_back(CDNSSeedData("tortoisecoinpool.org", "dnsseed.tortoisecoinpool.org"));
...
public:
    CTestNetParams() {
       ...
       //consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1230767999; // December 31, 2008
        ...
        genesis = CreateGenesisBlock(1732235901, 109999, 0x1e0ffff0, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5fde5d45a12491ef923f62405816d911ed0e056e61b0a1b7eda5425c929205c5"));
        assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        //vSeeds.push_back(CDNSSeedData("tortoisecointools.com", "testnet-seed.tortoisecointools.com"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.tortoisecoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("5fde5d45a12491ef923f62405816d911ed0e056e61b0a1b7eda5425c929205c5")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1732235901, 2000, 0x207fffff, 1, 100 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa60d02335bef9bcdfef9de3154f4b4ed9e7a57ccf7fdf9691eed4a8093e0cb66"));
        assert(genesis.hashMerkleRoot == uint256S("0x32aeb309fde2831bf43708997c590000fc31ed657ef8d6896906cbd15d0636f4"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0xa60d02335bef9bcdfef9de3154f4b4ed9e7a57ccf7fdf9691eed4a8093e0cb66"))
        };
