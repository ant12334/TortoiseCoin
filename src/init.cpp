...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/tortoisecoin-project/tortoisecoin>";
    const std::string URL_WEBSITE = "<https://tortoisecoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("tortoisecoin version %s\n", FormatFullVersion());
}
